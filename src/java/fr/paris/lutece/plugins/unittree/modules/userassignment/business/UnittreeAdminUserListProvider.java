package fr.paris.lutece.plugins.unittree.modules.userassignment.business;
...
public class UnittreeAdminUserListProvider implements IAdminUserListProvider {
	...
	private static final String MESSAGE_LABEL = "module.unittree.userassignment.task.user.assign.config.unittree";
